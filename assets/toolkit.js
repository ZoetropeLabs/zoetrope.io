...
var gEvents = function ($) {

  var linkSelector = 'a.btn';
  $(function () {
    if (!!window.ga) {
...
var headerResize = function ($) {
  ...
  function getImageSize() {
    ...
    var img_url = $('#stage').css('background-image').match(/url\(["']?([^"')]*?)["']?\)/)[1];
    bgImage.src = img_url;
  ...
  function resizeHeaderBackground() {
    ...
    var $angleBgElem = $('.solid-angle-bg');
    var offset = $angleBgElem.offset().top;
    var height = 350; // Magic number based on the angle
    var bgHeight = offset + height;
...
var zconnectSlideshow = function ($) {
  ...
  var updateSlides = function updateSlides() {
    $(elementSelector).each(function (index, elem) {
      var slides = $(slideSelector, elem);
